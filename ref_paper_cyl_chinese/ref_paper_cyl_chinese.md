---
slug: "ref_paper_cyl_chinese"
title: "Numerical Simulation of Low Reynolds Number Fluid-Structure Interaction with Immersed Boundary Method"
year: 2008
doi: null
source_pdf: "ref_paper_cyl_chinese.pdf"
sha256: "8cf04925fcce6c405095a9bb665e806d27e0e86290f98b2ac4c1a9300e0fb6a2"
pages: 6
figures: 10
figures_captioned: 8
references: 13
abstract: "This article introduces a numerical scheme on the basis of semi-implicit method for pressure-linked equations (SIMPLE) algorithm to simulate incompressible unsteady flows with fluid-structure interaction. The Navier-Stokes equation is discretized spatially with collocated finite volume method and Eulerian implicit m..."
...
postproc_schema: 1
outline:
  - "Numerical Simulation of Low Reynolds Number Fluid-Structure  Interaction with Immersed Boundary Method (p. 1)"
  - "Abstract (p. 1)"
  - "1. Introduction1 (p. 1)"
  - "2. Computational Scheme (p. 2)"
  - "2.1. Governing equation (p. 2)"
  - "2.2. Numerical scheme (p. 2)"
  - "(1) Momentum prediction (p. 2)"
  - "(2) Face flux calculation (p. 2)"
  - "2.3. Numerical algorithm (p. 3)"
  - "3. Results (p. 4)"
  - "3.1. Stationary cylinder (p. 4)"
  - "3.2 Oscillating cylinder (p. 5)"
  - "4. Conclusions (p. 6)"
  - "References (p. 6)"
  - "Biographies: (p. 6)"
---
...
![Fig.1 Different meshing methods.](_page_1_Picture_6.png)
...
![Fig.2 Relative position of point and cell.](_page_2_Picture_32.png)
...
![Fig.3 Schematic diagram showing calculation of VOF of immersed body.](_page_2_Picture_36.png)
...
![Fig.4 Time history of drag and lift coefficients with steady vortex shedding.](_page_3_Figure_22.png)
...
![Fig.5 shows the streamline distribution at different time. From it, it is seen that, before 200 s, a pair of symmetric vortices forms behind the cylinder and stretches with time...](_page_3_Figure_25.png)

![](_page_3_Figure_26.png)

<!-- page 5 -->

![Fig.5 Streamline distribution at different time.](_page_4_Figure_3.png)
...
![Fig.6 Time history of drag coefficients at Re =100 and KC = 5.](_page_4_Figure_19.png)
...
![Fig.7 Velocity vector and VOF contour at different stages in a single period.](_page_5_Figure_3.png)
...
*13 references moved to [ref_paper_cyl_chinese.refs.md](ref_paper_cyl_chinese.refs.md) to keep this file small.*
